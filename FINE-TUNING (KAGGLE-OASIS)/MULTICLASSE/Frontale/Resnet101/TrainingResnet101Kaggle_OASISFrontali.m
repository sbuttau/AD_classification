...
% moderate dementia)
% IMMAGINI FRONTALI
% FINE-TUNING SU OASIS - RESNET101 PRE-TRAINED SU KAGGLE
...
if ispc
  ...
  models_folder = "Mixed/Frontale/Resnet101";
  model_name = "resnet101kaggle_oasis_front_70ep_16mbs";
...
options = trainingOptions('adam',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",70,"ValidationFrequency",30,"MiniBatchSize", 16);
