...
% moderate dementia)
% IMMAGINI FRONTALI
% FINE-TUNING SU OASIS - ALEXNET PRE-TRAINED SU KAGGLE
...
if ispc
  ...
  models_folder = "Mixed/Frontale/Alexnet";
  model_name = "alexnetkaggle_oasis_front_70ep_128mbs";
...
options = trainingOptions('adam',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",70,"ValidationFrequency",30);
