...
if ispc
  ...
  models_folder = "Mixed/Intero/InceptionResnetV2/";
  model_name = "inceptionresnetv2kaggle_oasis_intero_100ep_8minibatch";
...
options = trainingOptions('adam',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",100,"ValidationFrequency",30,"MiniBatchSize",8);
