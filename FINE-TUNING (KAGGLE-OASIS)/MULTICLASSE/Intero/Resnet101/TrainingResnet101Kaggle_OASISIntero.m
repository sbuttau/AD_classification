...
if ispc
  ...
  models_folder = "Mixed/Intero/Resnet101";
  model_name = "alexnetkaggle_oasis_intero_100ep_8mbs";
  ...
  model_name = "resnet101kaggle_oasis_intero_100ep_8mbs";
end
...
options = trainingOptions('sgdm',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",100,"ValidationFrequency",30,"MiniBatchSize",8);
