...
% IMMAGINI LATERALI
% FINE-TUNING SU OASIS - ALEXNET PRE-TRAINED SU KAGGLE DATASET
...
if ispc
  ...
  models_folder = "Mixed/Binary/Alexnet";
...
layers(end - 2) = fullyConnectedLayer(classNumber); % Classificazione binaria
