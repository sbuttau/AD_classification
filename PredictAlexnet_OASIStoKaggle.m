% Classificazione livello di demenza (Dataset: kaggle, rete: Alexnet allenata su OASIS)
...
brainImgsDs.ReadFcn = @(filename)gray2rgb_resize(filename,227);  %Vengono ridimensionate le immagini del test
