% Classificazione livello di demenza (Dataset: kaggle, rete: Resnet101 allenata su OASIS)
...
brainImgsDs.ReadFcn = @(filename)gray2rgb_resize(filename,224);  %Vengono ridimensionate le immagini del test
