...
% alzheimer)
% CROSS-SECTIONAL
% STANDARD TRANSFER LEARNING - RESNET50


%-----------------------  DATASET ACQUISITION --------------------------
classNumber = 3;
augSize = 224;
models_folder = "D:\Sara\TEST\Results\Multiclass\Resnet50";
model_name = "resnet50_adni_multiclass_200ep_mbs30";
...
layers = replaceLayer(layers,'ClassificationLayer_fc1000',newCLLayer);

% Vengono settate le training options
options = trainingOptions('adam',"Plots","training-progress","ValidationData",valSet,"InitialLearnRate",0.0001,"MaxEpochs",200,"ValidationFrequency",30,"MiniBatchSize",30);
