...
classNumber = 3;
augSize = 224;
models_folder = "D:\Sara\TEST\Results\Multiclass\Googlenet";
model_name = "googlenet_adni_multiclass_200ep_mbs128";
...
layers = replaceLayer(layers,'loss3-classifier',newFCLayer);
newCLLayer = classificationLayer('Name','new_output');
layers = replaceLayer(layers,'output',newCLLayer);
