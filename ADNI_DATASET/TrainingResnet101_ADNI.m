...
classNumber = 3;
augSize = 224;
models_folder = "D:\Sara\TEST\Results\Multiclass\Resnet101";
model_name = "resnet101_adni_multiclass_200ep_mbs8";
...
options = trainingOptions('sgdm',"Plots","training-progress","ValidationData",valSet,"InitialLearnRate",0.0001,"MaxEpochs",200,"ValidationFrequency",30,"MiniBatchSize",8);
