...
options = trainingOptions('adam',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",30,"ValidationFrequency",30,"MiniBatchSize",15);
% -------------------    Train Network    -------------------------------
