...
% IMMAGINI LATERALI
% STANDARD TRANSFER LEARNING - GOOGLENET
...
if ispc
  ...
  models_folder = "Binary/Training/Googlenet";
  model_name = "googlenet_binary_oasis_300ep_128mbs";
...
[layerToReplace,classLayer] = findLayersToReplace(layers);
...
layers = replaceLayer(layers,layerToReplace.Name,newFCLayer);
newCLLayer = classificationLayer('Name','new_output');
layers = replaceLayer(layers,classLayer.Name,newCLLayer);
