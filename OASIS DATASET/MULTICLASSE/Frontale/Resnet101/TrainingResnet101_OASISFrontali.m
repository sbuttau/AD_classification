...
if ispc
  ...
  models_folder = "Multiclasse/Frontale/Resnet101/";
  model_name = "resnet101_oasis_front_70ep_16mbs";
...
options = trainingOptions('sgdm',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",70,"ValidationFrequency",30,"MiniBatchSize", 16);
