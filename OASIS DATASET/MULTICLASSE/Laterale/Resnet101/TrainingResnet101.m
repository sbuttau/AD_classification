% MULTICLASS CLASSIFICATION - (healthy, very mild dementia, moderate dementia)
...
if ispc
  ...
  models_folder = "Multiclasse/Laterale/Resnet101";
  model_name = "resnet101_laterale_oasis_200ep_15mbs";
