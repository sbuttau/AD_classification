...
if ispc
  ...
  models_folder = "Multiclasse/Laterale/InceptionResnetv2";
  model_name = "inceptionresnetv2_laterale_oasis_200ep_10mbs";
...
options = trainingOptions('adam',"Plots","training-progress","ValidationData",valAug,"InitialLearnRate",0.0001,"MaxEpochs",200,"MiniBatchSize",8,"ValidationFrequency",30);
